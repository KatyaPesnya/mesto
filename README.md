...
[Проектная работа на GitHub Pages](https://katyapesnya.github.io/mesto/)
...
```
git clone https://github.com/KatyaPesnya/mesto.git
...
[перенос кода на библиотеку Reactjs (ссылка на репозиторий)](https://github.com/KatyaPesnya/mesto-react)
